...
stripdir='/fs/project/howat.4/arctic_masswasting/fiveareas/strips/'; %Directory of strip DEM files.
codedir='/home/chunli/chunliwork/arcticdemapp/landslide/code1/';  %Directory of codes.
...
coregflag=8;%Recommend 8. 1 parameter (vertical), 3 parameter (Ian's); 7 parameter (MJ's); 8, MJ's setsm coregistration with 3 parameters.
...
regiondir='../arcticdem_18_russia_cherskly/';
tiledir='/work/chunli/ArcticDEMmosaics/';
